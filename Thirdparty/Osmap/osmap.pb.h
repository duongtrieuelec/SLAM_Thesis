...
class SerializedMapobject final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SerializedMapobject) */ {
 public:
  inline SerializedMapobject() : SerializedMapobject(nullptr) {}
  ~SerializedMapobject() override;
  explicit PROTOBUF_CONSTEXPR SerializedMapobject(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SerializedMapobject* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SerializedMapobject& from) {
    SerializedMapobject::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "SerializedMapobject";
  }
  protected:
  explicit SerializedMapobject(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class SerializedMapobjectArray final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:SerializedMapobjectArray) */ {
 public:
  inline SerializedMapobjectArray() : SerializedMapobjectArray(nullptr) {}
  ~SerializedMapobjectArray() override;
  explicit PROTOBUF_CONSTEXPR SerializedMapobjectArray(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  SerializedMapobjectArray* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const SerializedMapobjectArray& from) {
    SerializedMapobjectArray::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "SerializedMapobjectArray";
  }
  protected:
  explicit SerializedMapobjectArray(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SerializedMapobject >*
      mutable_mapobject();
  private:
  const ::SerializedMapobject& _internal_mapobject(int index) const;
  ::SerializedMapobject* _internal_add_mapobject();
  public:
  const ::SerializedMapobject& mapobject(int index) const;
  ::SerializedMapobject* add_mapobject();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SerializedMapobject >&
      mapobject() const;
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SerializedMapobject > mapobject_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_osmap_2eproto;
...
// .SerializedEllipsoid ellipsoid = 1;
inline bool SerializedMapobject::_internal_has_ellipsoid() const {
...
inline void SerializedMapobject::unsafe_arena_set_allocated_ellipsoid(
    ::SerializedEllipsoid* ellipsoid) {
  if (GetArenaForAllocation() == nullptr) {
...
inline ::SerializedMapobject* SerializedMapobjectArray::mutable_mapobject(int index) {
  ...
  return _impl_.mapobject_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SerializedMapobject >*
...
inline const ::SerializedMapobject& SerializedMapobjectArray::_internal_mapobject(int index) const {
  return _impl_.mapobject_.Get(index);
}
inline const ::SerializedMapobject& SerializedMapobjectArray::mapobject(int index) const {
  ...
  return _internal_mapobject(index);
}
inline ::SerializedMapobject* SerializedMapobjectArray::_internal_add_mapobject() {
  return _impl_.mapobject_.Add();
}
inline ::SerializedMapobject* SerializedMapobjectArray::add_mapobject() {
  ::SerializedMapobject* _add = _internal_add_mapobject();
  // @@protoc_insertion_point(field_add:SerializedMapobjectArray.mapobject)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::SerializedMapobject >&
